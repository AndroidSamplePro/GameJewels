...
import com.android.gamejewels.constants.IConstants;
import com.android.gamejewels.entity.BackgroundCell;
import com.android.gamejewels.entity.BorderSprite;
import com.android.gamejewels.entity.JewelSprite;
...
public class Jewels extends BaseGameActivity implements IOnSceneTouchListener, IConstants {
	...
	public void onLoadResources() {
		...
		/*背景*/
		interstitial = new InterstitialAd(this, getResources().getString(R.string.ad_publisher_id));
		
		AdRequest request = new AdRequest();
		request.addTestDevice("4BF3BEBBA3D94DBD03A136A191F0D58A");///nexus7//////testing
...
//				}
	...
	private void submitScore(){		
        ...
        Dialog dialog = new AlertDialog.Builder(this)
        .setTitle("GameOver")
        .setMessage("Game score: " + String.valueOf(mScore))
